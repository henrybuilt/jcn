...
But the below example app is showing many possible use-cases by using a global stylesheet, SCSS modules, and JCON style syntax (which generates CSS where dynamic scripts are not used).
